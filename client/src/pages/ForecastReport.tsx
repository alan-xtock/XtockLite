...
const getForecastReportData = (): ForecastReportData => {
  return {
    ...
    forecastBreakdown: [
      { item: "Crispy Brussels Sprouts", forecasted: "35", actual: "40", variance: "5", cost: "$14" },
      { item: "Fried Calamari", forecasted: "28", actual: "28", variance: "0", cost: "$14" },
      { item: "Spinach Artichoke Dip", forecasted: "22", actual: "20", variance: "-2", cost: "$14" },
      { item: "House Burger", forecasted: "45", actual: "40", variance: "-5", cost: "$14" },
      { item: "Grilled Salmon", forecasted: "26", actual: "26", variance: "0", cost: "$14" },
      { item: "Ribeye Steak", forecasted: "18", actual: "20", variance: "2", cost: "$14" },
      { item: "Fried Chicken Sandwich", forecasted: "38", actual: "38", variance: "0", cost: "$14" },
      { item: "Braised Short Rib", forecasted: "24", actual: "23", variance: "-1", cost: "$14" },
      { item: "Penne alla Vodka", forecasted: "20", actual: "20", variance: "0", cost: "$14" },
      { item: "Chocolate Lava Cake", forecasted: "19", actual: "19", variance: "0", cost: "$14" },
    ],
  };
};
